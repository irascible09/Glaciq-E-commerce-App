...
const Intro2 = ({ navigation, introscreen, setintroscreen }) => {
  return (
    <View style={styles.container}>

      <Image source={require('../../../assets/images/intro2photo.png')} style={styles.photo} />

      <View style={{ alignItems: 'center', marginTop: 30 }}>
        <Text style={{ fontSize: 27, fontWeight: 600 }}>Pure. Refreshing.</Text>
